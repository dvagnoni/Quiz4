...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    Quiz4LeftController *leftController = [[Quiz4LeftController alloc] initWithNibName:nil bundle:nil];
    Quiz4RightController *rightController = [[Quiz4RightController alloc] initWithNibName:nil bundle:nil];
